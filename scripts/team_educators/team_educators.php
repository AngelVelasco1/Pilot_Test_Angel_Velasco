...
{
    private $queryPost = 'INSERT INTO team_educators(id, name_rol) VALUES (:identification, :rol, :id_country)';
    private $queryGet = 'SELECT id AS "identification", SELECT name_rol AS "rol", SELECT id_country AS "id_country" FROM team_educators';
